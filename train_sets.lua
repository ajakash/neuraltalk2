...
require 'loadcaffe'
-- local imports
local utils = require 'misc_sets.utils'
require 'misc_sets.DataLoader'
require 'misc_sets.LanguageModel'
local net_utils = require 'misc_sets.net_utils'
require 'misc_sets.optim_updates'
...
cmd = torch.CmdLine()
cmd:text()
cmd:text('Train an Image Set Captioning model')
cmd:text()
cmd:text('Options')

-- Data input settings
cmd:option('-input_h5','sets/data.h5','path to the h5file containing the preprocessed dataset')
cmd:option('-input_json','sets/data.json','path to the json file containing additional info and vocab')
